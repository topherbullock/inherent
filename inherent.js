...
function clone ( classPrototype , classPrototypeClone, propertyNames ) {
  classPrototypeClone = classPrototypeClone || {};
  ...
  propertyNames.forEach(function ( propName ) {
    ...
    Object.defineProperty( classPrototypeClone, propName, descriptor );
  });

  return classPrototypeClone;
}
